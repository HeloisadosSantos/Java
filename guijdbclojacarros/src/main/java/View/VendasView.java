...
public class VendasView extends JPanel {
    ...
    public VendasView() {
        ...
        rgField.setBackground(Color.BLACK);
        rgField.setForeground(Color.WHITE);
        rgField.setBorder(BorderFactory.createLineBorder(Color.WHITE));
        rgField.setFont(inputFont);
        ...
        cpfField.setBorder(BorderFactory.createLineBorder(Color.WHITE));
        cpfField.setFont(inputFont);
        inputPanel.add(cpfField);

        inputPanel.add(new JLabel("Ano"));
        anoField = new JTextField(20);
        anoField.setBackground(Color.BLACK);
        anoField.setForeground(Color.WHITE);
        anoField.setBorder(BorderFactory.createLineBorder(Color.WHITE));
        anoField.setFont(inputFont);
        inputPanel.add(anoField);

        inputPanel.add(new JLabel("Data de Nascimento"));
        dataNascimentoField = new JTextField(20);
        dataNascimentoField.setBackground(Color.BLACK);
        dataNascimentoField.setForeground(Color.WHITE);
        dataNascimentoField.setBorder(BorderFactory.createLineBorder(Color.WHITE));
        dataNascimentoField.setFont(inputFont);
        ...
        nomeField.setBorder(BorderFactory.createLineBorder(Color.WHITE));
        nomeField.setFont(inputFont);
        inputPanel.add(nomeField);

        inputPanel.add(new JLabel("Endereço"));
        enderecoField = new JTextField(20);
        enderecoField.setBackground(Color.BLACK);
        enderecoField.setForeground(Color.WHITE);
        enderecoField.setBorder(BorderFactory.createLineBorder(Color.WHITE));
        enderecoField.setFont(inputFont);
        inputPanel.add(enderecoField);

        inputPanel.add(new JLabel("Cidade"));
        cidadeField = new JTextField(20);
        cidadeField.setBackground(Color.BLACK);
        cidadeField.setForeground(Color.WHITE);
        cidadeField.setBorder(BorderFactory.createLineBorder(Color.WHITE));
        cidadeField.setFont(inputFont);
